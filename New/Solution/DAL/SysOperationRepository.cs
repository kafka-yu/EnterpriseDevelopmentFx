...
namespace NkjSoft.DAL
{
    ...
    /// 操作
    /// </summary>
    public class SysOperationRepository : BaseRepository<SysOperation>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<SysMenu> GetRefSysMenu(SysEntities db, string id)
        {
        ...
        public void Delete(SysEntities db, string id)
        {
            ...
            if (deleteItem != null)
            { 
                db.SysOperation.DeleteObject(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
