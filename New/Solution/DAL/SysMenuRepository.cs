...
namespace NkjSoft.DAL
{
    ...
    /// 菜单
    /// </summary>
    public class SysMenuRepository : BaseRepository<SysMenu>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<SysOperation> GetRefSysOperation(SysEntities db, string id)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<SysOperation> GetRefSysOperation(SysEntities db)
        {
            return from m in db.SysMenu
                   from f in m.SysOperation
                   select f;
