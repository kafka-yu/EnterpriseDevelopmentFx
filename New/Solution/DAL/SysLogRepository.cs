...
namespace NkjSoft.DAL
{
    ...
    /// 日志
    /// </summary>
    public class SysLogRepository : BaseRepository<SysLog>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<SysLog> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
