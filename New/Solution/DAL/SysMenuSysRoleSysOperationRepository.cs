...
namespace NkjSoft.DAL
{
    ...
    /// 角色菜单操作
    /// </summary>
    public class SysMenuSysRoleSysOperationRepository : BaseRepository<SysMenuSysRoleSysOperation>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        public IQueryable<SysMenuSysRoleSysOperation> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return db.SysMenuSysRoleSysOperation
        ...
        /// <summary>
        /// 通过主键id，获取角色菜单操作---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>角色菜单操作</returns>
