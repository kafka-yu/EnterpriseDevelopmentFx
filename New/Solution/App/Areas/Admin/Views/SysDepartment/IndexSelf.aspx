    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                striped: true,
                collapsible: true,
                url: '/Admin/SysDepartment/GetData', //获取数据的url
                sortName: 'Id',
                sortOrder: 'desc',
                idField: 'Id',
                ...
                columns: [[
					...
					,{ field: 'ParentId', title:  '<%: Html.LabelFor(model => model.ParentId) %>', width: 113 }
					,{ field: 'Address', title:  '<%: Html.LabelFor(model => model.Address) %>', width: 113 }
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "/Admin/SysDepartment/Details/" + arr[0].Id;
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "/Admin/SysDepartment/Edit/" + arr[0].Id;
        ...
        function flexiDelete() {
            ...
            $.messager.confirm('操作提示', "确认删除这 " + arr.length + " 项吗？", function (r) {
                if (r) {
                    $.post("/Admin/SysDepartment/Delete", { query: arr.join(",") }, function (res) {
                        if (res == "OK") {
                           //移除删除的数据
