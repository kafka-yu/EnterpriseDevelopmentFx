<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<NkjSoft.DAL.SysMenuSysRoleSysOperation>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "/Admin/SysMenuSysRoleSysOperation/Details/" + arr[0].Id;
        ...
        function flexiCreate() {
            ...
            window.location.href = "/Admin/SysMenuSysRoleSysOperation/Create";
            return false;
        }
        //导航到修改的按钮
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "/Admin/SysMenuSysRoleSysOperation/Edit/" + arr[0].Id;
        ...
        function flexiDelete() {
            ...
            $.messager.confirm('操作提示', "确认删除这 " + arr.length + " 项吗？", function (r) {
                if (r) {
                    $.post("/Admin/SysMenuSysRoleSysOperation/Delete", { query: arr.join(",") }, function (res) {
                        if (res == "OK") {
                           //移除删除的数据
