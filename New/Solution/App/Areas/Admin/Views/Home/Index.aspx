...
<head id="Head1" runat="server">
    ...
    <link href="<%: Url.Content("~/Res/easyui/themes/metro/easyui.css") %>" rel="stylesheet" type="text/css" />
    <link href="<%: Url.Content("~/Content/easyui.metro.modify.css") %>" rel="stylesheet" type="text/css" />
    <link href="<%: Url.Content("~/Content/default.css") %>" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        $(function () {
            tabCloseEven();
            addTab("我的工作台", "/Admin/Home/MyWorkStation", "tu1112", false);
            $('ul li .tree-node').click(function () {
                var $trigger = $(this).children(".tree-title:first").find("a");

                var tabTitle = $trigger.text();
                var url = $trigger.attr("rel"); //获取地址
                var id = $trigger.attr("id"); //获取id
                var icon = $trigger.attr("icon"); //获取图标
                if (icon == "") {
                    icon = "icon-save";
                }
    ...
    <style type="text/css">
        ...
        #menuTree .tree-node-selected a,#menuTree .tree-node-selected span{
            font-weight:bold;
            color:#0078B1;
        }
...
<body class="easyui-layout">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 76px; line-height: 20px; background-color: rgb(0, 120, 177); font-family: 微软雅黑,黑体">
        <div id="mainlogo">
    ...
    <div region="west" hide="true" split="true" title="导航菜单" style="width: 180px;" id="west">
        <div class="easyui-accordion" id="menuTree" fit="true" border="false" animate="false">
            <%= ViewData["Menu"] %>
        </div>
    </div>
