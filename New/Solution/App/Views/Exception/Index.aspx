<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<Models.BaseException>" %>
<html>
<head runat="server">
    <title>异常处理页面</title>
    <style type="text/css">
...
<body>
    <div style="text-align:center;width:100%">
        <table width="600" class="blueTab" border="0" cellspacing="1" cellpadding="1">
            <tr>
                <td colspan="3">
        ...
        <a id="showMessage" href="javascript:void(0);" onclick="ShowErrorMessage();return false;">显示详细信息</a>
    </div>
</body>
</html>
