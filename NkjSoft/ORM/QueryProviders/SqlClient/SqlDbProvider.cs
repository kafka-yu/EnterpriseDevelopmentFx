...
namespace NkjSoft.ORM.Data.SqlClient
{
    ...
    public class SqlDbProvider : DbEntityProvider
    {
        ...
        {
            return string.Format(@"Data Source=.\SQLEXPRESS;Integrated Security=True;Connect Timeout=30;MultipleActiveResultSets=true;AttachDbFilename='{0}'", databaseFile);
        }
        ...
        {
            SqlDbProvider provider;

            public Executor(SqlDbProvider provider)
                : base(provider)
            {
