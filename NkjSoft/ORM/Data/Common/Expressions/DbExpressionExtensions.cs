...
namespace NkjSoft.ORM.Data.Common
{
    public static class DbExpressionExtensions
    {
        ...
        /// <returns></returns>
        public static TResult GetAttributeValue<TAttribute, TResult>(this MappingEntity entity, Func<TAttribute, TResult> valueSelector) where TAttribute : Attribute
        {
            object attr = (typeof(MappingEntity)).GetCustomAttributes(typeof(TAttribute), false).FirstOrDefault();
            if (attr == null)
