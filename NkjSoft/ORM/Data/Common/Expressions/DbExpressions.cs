...
namespace NkjSoft.ORM.Data.Common
{
    ...
    public class UpdateCommand : CommandExpression
    {
        ...
        // ColumnIndeedExpression indeedColumn;

        //public ColumnIndeedExpression IndeedColumns
        //{
        //    get { return indeedColumn; }
        //    set { indeedColumn = value; }
        //}
        ...
        ///// <param name="where">The where.</param>
        ///// <param name="assignments">The assignments.</param>
        ///// <param name="indeedColumn">The indeed column.</param>
        //public UpdateCommand(TableExpression table, Expression where, IEnumerable<ColumnAssignment> assignments, ColumnIndeedExpression indeedColumn)
        //    : base(DbExpressionType.Update, typeof(int))
        //{
        //    this.table = table;
        //    this.where = where; 
