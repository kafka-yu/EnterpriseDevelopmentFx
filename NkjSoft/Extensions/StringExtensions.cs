...
namespace NkjSoft.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// 将 当前字符串实例转换成 <typeparamref name="TResult"/> 值类型类型。
        /// </summary>
        /// <typeparam name="TResult">需要得到的类型。</typeparam>
        /// <param name="source">当前字符串实例</param>
        /// <exception cref="System.ArgumentException">无效的字符串视图转换成目标 <typeparamref name="TResult"/> 类型</exception>
        /// <exception cref="System.FormatException">格式转换错误</exception>
        /// <returns></returns>
        public static TResult To<TResult>(this string source)
            where TResult : struct
        {
            return NkjSoft.Common.DataUtils.ConvertValue<TResult>(source);
        }

        /// <summary>
        /// 将 当前字符串实例转换成 <typeparamref name="TResult"/> 值类型类型。指定一个值，将在转换操作失败的时候返回。
        /// </summary>
        /// <typeparam name="TResult">需要得到的类型。</typeparam>
        /// <param name="source">当前字符串实例</param>
        /// <param name="defaultIfFalse">当转换失败的时候返回的值。</param>
        /// <returns></returns>
        /// <exception cref="System.ArgumentException">无效的字符串视图转换成目标 <typeparamref name="TResult"/> 类型</exception>
        /// <exception cref="System.FormatException">格式转换错误</exception>
        public static TResult To<TResult>(this string source, TResult defaultIfFalse)
            where TResult : struct
        {
            return NkjSoft.Common.DataUtils.ConvertValue<TResult>(source, defaultIfFalse);
        }
